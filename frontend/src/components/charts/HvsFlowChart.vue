...
import type { HvsFlowGraphDataResponse } from "@/api/types";
...
interface HvsFlowChartProps {
  data: HvsFlowGraphDataResponse[];
  loading?: boolean;
  plugins?: any[];
}

const props = withDefaults(defineProps<HvsFlowChartProps>(), {
  loading: false,
  plugins: () => [],
});
